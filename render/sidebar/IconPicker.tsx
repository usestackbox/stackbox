  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: C.r4, boxShadow: C.shadowXl,
        display: "flex", flexDirection: "column",
        zIndex: 99999, overflow: "hidden",
      }}
    >
      <div style={{ padding: "10px 10px 6px", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, background: C.bg0, border: `1px solid ${C.border}`, borderRadius: C.r2, padding: "5px 10px" }}>
          ...
          <input
            ...
            style={{ background: "none", border: "none", outline: "none", color: C.t0, fontSize: FS.md, fontFamily: SANS, flex: 1 }}
          />
        </div>
      </div>
        ...
        <div style={{ display: "flex", gap: 2, padding: "0 10px 6px", flexShrink: 0, overflowX: "auto" }}>
          {ICON_GROUPS.map((g, i) => (
            <button
              ...
              style={{
                border: "none", cursor: "pointer", borderRadius: C.r2, padding: "3px 9px",
                fontSize: FS.xxs, fontFamily: MONO, fontWeight: 700, letterSpacing: ".08em",
                whiteSpace: "nowrap", background: activeGroup === i ? C.bg4 : "transparent",
                color: activeGroup === i ? C.t0 : C.t3, transition: "all .12s",
              }}
            >
              {g.label}
            </button>
      ...
      <div style={{
        ...
        display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 4, alignContent: "start",
      }}>
        {filtered.map((icon, i) => (
          <button
            key={i}
        ...
        {filtered.length === 0 && (
          <div style={{ gridColumn: "1/-1", padding: "20px 0", textAlign: "center", color: C.t3, fontSize: FS.sm, fontFamily: SANS }}>
            No icons found
          </div>
        )}
      </div>
