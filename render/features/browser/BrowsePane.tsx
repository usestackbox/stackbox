    ...
    <div onClick={onActivate} style={{ display: "flex", flexDirection: "column", width: "100%", height: "100%" }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ width: 5, height: 5, borderRadius: "50%", background: dotBg,
            boxShadow: connError ? "none" : `0 0 4px ${dotBg}` }} />
          <span style={{ fontSize: 10, fontFamily: MONO, color: connError ? "#cc8888" : "#88bb88" }}>
            :{port}
          </span>
        </div>
        ...
        <input
          ...
          style={{
            ...
            color: C.t2, fontSize: 11, padding: "3px 0",
            outline: "none", fontFamily: MONO, cursor: "text",
          }}
        ...
        <button onClick={e => { e.stopPropagation(); reload(); }}
          style={{ background: "none", border: "none", cursor: "pointer",
            color: C.t3, fontSize: 14, padding: "2px 4px", borderRadius: 4, lineHeight: 1 }}
      ...
      {loading && (
        <div style={{ height: 1.5, background: C.bg2, flexShrink: 0, overflow: "hidden" }}>
          <div style={{ height: "100%", width: "40%", background: "rgba(80,160,80,.6)",
      ...
      {connError && !loading && (
        <div style={{ flex: 1, display: "flex", flexDirection: "column",
          alignItems: "center", justifyContent: "center", gap: 8, background: C.bg0 }}>
          <span style={{ fontSize: 11, color: C.t2, fontFamily: MONO }}>
            {urlInput} — not reachable
          </span>
          <button onClick={reload} style={{ fontSize: 10, color: C.t2, background: "none",
            border: `1px solid ${C.border}`, borderRadius: 5, padding: "4px 12px",
      ...
      <div ref={slotRef} style={{ flex: 1, minHeight: 0, minWidth: 0,
        background: C.bg0, pointerEvents: "none" }} />
