...
export function FileSearch({ root, onClose, onOpenFile }: Props) {
  ...
  const [filterExt, _setFilterExt] = useState("");
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: C.bg1 }}>
      ...
      >
        ...
        <button
          ...
          style={{
            border: "none",
            background: showReplace ? "rgba(59,130,246,.15)" : "transparent",
            color: showReplace ? "#3b82f6" : "rgba(255,255,255,.55)",
            borderRadius: 6,
            width: 26,
            height: 26,
            cursor: "pointer",
      ...
      >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <button
              ...
              style={{
                ...
                color: results.length ? "#60a5fa" : "#4a5568",
                borderRadius: 6,
                fontSize: 11,
                fontFamily: MONO,
                fontWeight: 600,
        ...
        {searchErr && (
          <span style={{ fontSize: 10, fontFamily: MONO, color: "#ef4444", paddingInline: 2 }}>
            {searchErr}
          </span>
        )}
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", paddingBottom: 12 }}>
        {Object.entries(grouped).map(([filePath, matches]) => {
          ...
          const fDir = short.includes("/")
            ? short.replace(/\\/g, "/").split("/").slice(0, -1).join("/")
            : "";
          return (
            <div key={filePath} style={{ marginBottom: 2 }}>
              ...
              >
                ...
                <span style={{ fontSize: 12, fontFamily: SANS, color: "#c8d3e0", fontWeight: 500 }}>
                  {fName}
                </span>
                {fDir && (
                  <span
              ...
              {!isCollapsed &&
                matches.map((m, i) => (
                  <div
                    ...
                    onMouseEnter={(e) =>
                      ((e.currentTarget as HTMLElement).style.background = "rgba(54,69,79,.4)")
                    }
                    onMouseLeave={(e) =>
