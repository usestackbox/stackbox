...
import type { useSettings, McpServerConfig } from "./useSettings";
        ...
        {settings.mcpServers.map((s, i) => (
          <div
            ...
            style={{
              ...
              borderBottom: i < settings.mcpServers.length - 1 || adding
                ? `1px solid ${C.borderSubtle}` : "none",
            }}
          >
            ...
            <button
              ...
              style={{
                ...
                color: C.red, cursor: "pointer", fontSize: 18, lineHeight: 1,
        ...
        {adding && (
          <div style={{ padding: "12px 14px", display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <input
              ...
              onKeyDown={e => { if (e.key === "Enter") addServer(); if (e.key === "Escape") setAdding(false); }}
              style={inputStyle}
            />
            <div style={{ display: "flex", gap: 8 }}>
              <button onClick={addServer} style={btnPrimary}>Add</button>
      ...
      {!adding && (
        <button
          ...
          style={{
            ...
            padding: "6px 14px", fontSize: 12, fontFamily: SANS,
...
const inputStyle: React.CSSProperties = {
  ...
  padding: "6px 10px", fontSize: 12, fontFamily: SANS,
